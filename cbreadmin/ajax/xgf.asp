...
table=request("table")
 select case Action
  ...
  case "add"
  conn.execute"INSERT INTO ["&table&"] (tit,txt,oid,fid,[file],uptime,jg) VALUES ('"&tit&"','"&text2html(txt)&"','"&oid&"','"&fid&"','"&file&"','"&now()&"','"&jg&"')"

  case "mod"
  conn.execute"update ["&table&"] set tit='"&tit&"',txt='"&text2html(txt)&"',oid="&oid&",uptime='"&now()&"',[file]='"&file&"',jg='"&jg&"' where id="&id&""
